    ...
    constructor() {
        this.stories = {
            story1: {
                ...
                content: `
                    <div class="prose max-w-none">
                        <h2 class="text-3xl font-bold mb-6 text-center text-white">The Last Sakura</h2>
            ...
            story2: {
                ...
                content: `
                    <div class="prose max-w-none">
                        <h2 class="text-3xl font-bold mb-6 text-center text-white">Guardian's Path</h2>
                        <p class="text-lg mb-4 text-gray-300">
            ...
            story3: {
                ...
                content: `
                    <div class="prose max-w-none">
                        <h2 class="text-3xl font-bold mb-6 text-center text-white">Whispers of Spring</h2>
                        <p class="text-lg mb-4 text-gray-300">
